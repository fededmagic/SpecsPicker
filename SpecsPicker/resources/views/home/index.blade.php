        ...
        <div class="col-md-6 text-center">
            <form method="POST">
                ...
                <div class="form-group row">
                    <label for="txtInput" class="col-lg-4 col-md-4 col-sm-12 col-form-label">Nome del software:</label>
                    ...
                    <div class="form-group row mt-3">
                      <div class="col-lg-8 col-md-8 col-sm-12 offset-md-4">
                        <textarea id="txtArea" name="txtArea" class="form-control"></textarea>
                    </div>
                </div>
            </form>
        </div>
